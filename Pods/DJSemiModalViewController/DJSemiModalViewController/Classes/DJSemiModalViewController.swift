...
open class DJSemiModalViewController: UIViewController {
    ...
    private lazy var contentViewMaximumWidthLayoutConstraint: NSLayoutConstraint = {
        let constraint  = contentView.widthAnchor.constraint(equalToConstant: maxWidth)
    ...
    public let widthButton: UIButton = {
        let button = UIButton()
        button.addTarget(self, action: #selector(widthButtonAction), for: .touchUpInside)
    ...
    private func setupCloseButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            closeButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: 0),
...
extension DJSemiModalViewController {
    ...
    @IBAction private func widthButtonAction(_ sender: Any){
        print("Работает")
    }
